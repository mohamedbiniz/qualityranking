 ...
 * @subpackage  form
 */
class XoopsInterlizeThemeForm extends XoopsForm
{
	/**
		...
		foreach ( $this->getElements() as $ele ) {
			if (!is_object($ele)) {
				...
				if ($ele->isSingleline()) {
					...
					//	$class = 'odd';
					//}
					$ret .= "<tr valign='middle' align='left'><td colspan='2' class='odd'>".$ele->getCaption();
					...
					//	$class = 'odd';
					//}
					$ret .= "<tr valign='middle' align='left'><td class='head'>".$ele->getCaption();
					if ($ele->getDescription() != '') {
						$ret .= '<br /><br /><span style="font-weight: normal;">'.$ele->getDescription().'</span>';
					}
