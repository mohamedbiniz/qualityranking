...
class XoopsFormPassword extends XoopsFormElement {
	 ...
	 */
	function render(){
		return "<input type='password' class='inputPassword' name='".$this->getName()."' id='".$this->getId()."' size='".$this->getSize()."' maxlength='".$this->getMaxlength()."' value='".$this->getValue()."'".$this->getExtra()." />";
	}
}
?>