<?php 
// $Id: grouppermform.php,v 1.14 2004/06/14 14:22:12 skalpa Exp $
// ------------------------------------------------------------------------ //
...
// ------------------------------------------------------------------------- //
require_once DIR_INCLUDES . 'xoopsform/formelement.php';
require_once DIR_INCLUDES . 'xoopsform/formhidden.php';
require_once DIR_INCLUDES . 'xoopsform/formbutton.php';
require_once DIR_INCLUDES . 'xoopsform/formelementtray.php';
require_once DIR_INCLUDES . 'xoopsform/form.php';
