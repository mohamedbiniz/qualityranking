...
public class YahooSearch extends SearchEngine {
    ...
    public List<Result> search(String query) throws SearchException {
        try {
            ...
            String URL = "http://search.yahooapis.com/WebSearchService/V1/webSearch?appid=" + getAppID() + "&query=economia&results=" + getMaxResults();
            ...
            NodeList nodes = (NodeList) xpath.evaluate("/ResultSet/Result", doc, XPathConstants.NODESET);
            for (int i = 0; i < nodes.getLength(); i++) {
                ...
                result.setSummary(elem.getElementsByTagName("Summary").item(0).getTextContent());
                results.add(result);
            }
