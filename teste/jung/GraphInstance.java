...
private String prevTerm=null;
	...
	/**
	 *Esta classe � responsavel por colocar label nos vertices do grafo. 
	 */
	private StringLabeller vlabeller;
	
	/**
	 * Esta classe � resposavel por colocar label nas arestas 
	 */
	public EdgeWeightLabeller elabeller;
		
	/**
	 * Grafo que representa a rela��o entre os termos de uma cole��o.
	 * 
	 */
	private Graph graph;
	
	/**
	 * � uma referencia para o vertice que mais aparece no grafo. Equivale ao 
	 * termo mais comum, ou seja, o de maior probabilidade e de menor energia.
	 */	
	SparseVertex mostCommon;
	
	/**
	* � a chave para o UserData que contem o nome do termo contido dentro 
	* do vertice. 
	 */
	private String vertexName = "vertexName";
	/**
	 * � a chave para o valor do vertice. Na pratica � o numero de vezes que
	 * o termo aparece na cole�ao
	 */
	 ...
	 * @param term � o conteudo do vertex e tambem a chave da hashtable
	...
	/**
	 * Atualiza os dados de uma aresta. N� pratica apenasa incrementa o contador
	...
	private DirectedSparseEdge findEdge(SparseVertex vertexFrom, SparseVertex vertexTo) {
		...
		Set<DirectedSparseEdge> edges = vertexFrom.getOutEdges();
		
		Iterator<DirectedSparseEdge> it = edges.iterator();
		while(it.hasNext())
		{
			edge = it.next();
	...
	/**
	 * Cada aresta do greafo deve ter uma representan��o que lhe 
	 * serve como chave. Este metodo calcula esta chave;
	 * Trivialemente a representa��o � definida como
	 * termFrom->termTo
	 ...
	 * trivialmente a atualiza��o corresponde ao numero de vezes que o
	 * termo aparece na cole��o, portanto basta que atualizamos
	 * o contador interno do vertice;
	 * Al�m disso este m�todo atualiza o vertice mais comum da cole��o.
	 * Note que se nenhum vertice ocorrer mais vezes, entao todos os vertices
	 * ter�o ocorrido 1 unica vez e portanto sendo indiferente escolher o mais comum.
	 * 
	 * @param term
	 */
