...
public class TestCrawler2 extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        Page page = new Page();
        page.setId(101);
        page.setContent("fjsdfkljsdfsdfjks�dlfjksdkljfkdlsjfkls");
    ...
    public void testGetAll() throws Exception {
        ODB odb = ODB.open("crawler2.odb");
        List<Page> l = odb.getObjectsOf(Page.class, true);
    ...
    public void testGetNativeQuery() throws Exception {
        ...
        List<Page> l = odb.getObjects(nq, true);
    ...
    public void testSodaQuery() throws Exception {
        ...
        List<Page> l = odb.getObjects(sodaquery, true);
        assertEquals(1, l.size());
