...
public class LinkExtractor {
	...
	public static Collection<OutputLinkCrawler> getLinks(String path, String domain, long idDataSet)
			throws IOException {
		...
		/*
		 * A extracao dos links � realizado no arquivo localmente, sendo assim
		...
		Collection<OutputLinkCrawler> outLinks = URLFilter.getValidOutputLinks(urls, idDataSet);
