...
public class Coupling {
	 ...
	 */
	public Map<Integer, Double> coupling(String link) {
	 ...
	 * @return A Map with the Coupling score between the given link and all other
         ...
         *         and values correspond to the Coupling score
	 */
	private Map<Integer, Double> coupling(Integer id) {
		if(id.intValue()!=0) {
	...
	private Double computeCoupling(Integer id1, Integer id2) {
		...
		int score3 = 0;
		Double score;
		Map<Integer, Double> map1 = graph.outLinks(id1);
		Map<Integer, Double> map2 = graph.outLinks(id2);
