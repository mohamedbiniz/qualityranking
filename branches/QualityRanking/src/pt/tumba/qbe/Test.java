...
public class Test {
	 ...
	 */
	{
		...
		for (int i = stopSiteList.length - 1; i >= 0; i--)
			stopSites.put(stopSiteList[i], null);
		stopSiteList = null;
	}
	...
	private Map<Integer, String> documentSnippets;

	private List relatedPages;
	
	public Test () {
		documentTitles = new HashMap<String, String>();
		documentSnippets = new HashMap<Integer, String>();
		graph = new WebGraph();
	...
	public void computeRelated ( String URL ) {
			...
			Map<Integer, Double> map = amsler.amsler(URL);
