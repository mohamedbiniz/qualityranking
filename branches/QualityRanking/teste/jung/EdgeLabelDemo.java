...
public class EdgeLabelDemo extends JApplet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1639468874390054562L;
    ...
    public EdgeLabelDemo() {
        ...
        Vertex v1 = graph.addVertex(new SparseVertex());
        Vertex v2 = graph.addVertex(new SparseVertex());
        Vertex v3 = graph.addVertex(new SparseVertex());
        //Vertex v4 = graph.addVertex(new SparseVertex());
        //Vertex v5 = graph.addVertex(new SparseVertex());
   
        Edge e = graph.addEdge(new DirectedSparseEdge(v0, v1));
        Edge e1 = graph.addEdge(new DirectedSparseEdge(v1, v2));
        Edge e2 = graph.addEdge(new DirectedSparseEdge(v2, v3));
        Edge e3 = graph.addEdge(new DirectedSparseEdge(v3, v0));
        

//        v0.isSource(e);     // evaluates to true
//        v1.isSource(e);     // evaluates to true
//        v0.isDest(e);       // evaluates to true
//        v1.isDest(e);       // evaluates to true
//        
//        v0.isPredecessorOf(v1);     // evaluates to true
//        v1.isPredecessorOf(v0);     // evaluates to true
//        v0.isSuccessorOf(v1);       // evaluates to true
//        v1.isSuccessorOf(v0);       // evaluates to true
        ...
        JSlider directedSlider = new JSlider(mv.getDirectedModel()) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -3981072847493809191L;
        ...
        JSlider undirectedSlider = new JSlider(mv.getUndirectedModel()) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -7248106799094065393L;
        ...
        JSlider edgeOffsetSlider = new JSlider(0,50) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -5125067114718138252L;
    ...
    void createEdges(Vertex[] v) {
        ...
        graph.addEdge(new DirectedSparseEdge(v[3], v[4]));
        graph.addEdge(new UndirectedSparseEdge(v[4], v[5]));
        graph.addEdge(new UndirectedSparseEdge(v[3], v[5]));
        graph.addEdge(new UndirectedSparseEdge(v[5], v[8]));
        graph.addEdge(new UndirectedSparseEdge(v[6], v[2]));
        graph.addEdge(new UndirectedSparseEdge(v[7], v[2]));
        graph.addEdge(new UndirectedSparseEdge(v[9], v[8]));
        graph.addEdge(new UndirectedSparseEdge(v[9], v[4]));
    }
    ...
    public static void main(String[] args) {
        ...
        EdgeLabelDemo j= new EdgeLabelDemo();
