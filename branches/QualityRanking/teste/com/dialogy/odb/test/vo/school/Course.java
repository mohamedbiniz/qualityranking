...
public class Course {
    ...
    public Course(String name) {
        this.name = name;
        this.listOfDiscipline = new ArrayList<Discipline>();
    }
    ...
    public List<Discipline> getListOfDiscipline() {
        return listOfDiscipline;
    }

    public void setListOfDiscipline(List<Discipline> listOfDiscipline) {
