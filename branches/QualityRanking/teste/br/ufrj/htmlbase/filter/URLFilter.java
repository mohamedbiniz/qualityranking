...
public class URLFilter {
	...
	public static Collection<OutputLinkCrawler> getValidOutputLinks(URL[] urls, long idDataSet)
			throws IOException {

		Hashtable<Integer, OutputLinkCrawler> outLinksHash = new Hashtable<Integer, OutputLinkCrawler>();
	...
	private static Collection<OutputLinkCrawler> filterUrls(
