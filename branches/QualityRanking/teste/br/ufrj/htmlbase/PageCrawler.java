...
public class PageCrawler {
	...
	protected Collection<OutputLinkCrawler> urls;

	// lista de p�ginas filhas
	...
	private Collection<OutputLinkCrawler> processLinks() throws IOException {
	...
	public Collection<OutputLinkCrawler> getUrls() {
		return urls;
	}

	public void setUrls(Collection<OutputLinkCrawler> urls) {
		this.urls = urls;
	}
