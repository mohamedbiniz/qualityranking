 ...
 * @subpackage  form
 */
class XoopsThemeNoForm extends XoopsForm
{
	/**
	...
	function render()
	{
		...
		$ret = "<table  class='outer' cellspacing='0' cellpadding='0' align='center'><tr><th colspan='2'>".$this->getTitle()."</th></tr>";
		//$count = 0;
		foreach ( $this->getElements() as $ele ) {
			if (!is_object($ele)) {
				...
				if ($ele->isSingleline()) {
					...
					//	$class = 'odd';
					//}
					$ret .= "<tr valign='top' align='left'><td colspan='2' class='$class'>".$ele->getCaption();
